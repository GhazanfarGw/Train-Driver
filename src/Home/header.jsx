  ...
  return (
    <header
      className={`fixed z-50 w-full transition-all duration-500 ${
        isScrolled
          ? "bg-[#E6E6F6] shadow-sm border-b border-b-[#324E91]/80"
          : "text-white"
      }`}
    >
      ...
      >
        <ul className="space-y-4 text-sm">
          ...
          <p className="text-sm px-6 pt-6 text-[#4b4b4b]">
            Train Driver solutions offers to convert your cryptocurrency into
            cash, ensuring a secure and efficient process.
          </p>
